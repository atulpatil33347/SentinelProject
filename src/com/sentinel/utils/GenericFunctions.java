...
public class GenericFunctions extends WebDriverTestBase {
	...
	public void sendmail() {
		...
		String to = "atul963@yahoo.com";

		// Sender's email ID needs to be mentioned
		String from = "atul.patil@cygnetinfotech.com";

		final String username = "atul.patil@cygnetinfotech.com";// change accordingly
		final String password = "Hah95112";// change accordingly
		...
		try {
			...
			File file=new File("/SentinelProject/target/surefire-reports/html");
